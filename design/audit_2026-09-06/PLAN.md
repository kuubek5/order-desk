...
| B.4 | ⬜ | Ранбук випробування на локальному 8002 перед кожним релізом: створити бекап → відновити в порожню базу → звірити числа; імітувати оновлення (підмінити версію) → побачити зелений рядок звірки; видалити тестову роботу → знайти вміст рядка в журналі. Записати результат тут. |
