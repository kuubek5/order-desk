...
class SismaReading:
    ...
    # None = стан не прочитано. Поле ЩЕ НІХТО не читає в застосунку (ревʼю
    # 07.09.26 називав його мертвим), але воно лишається свідомо: у ньому
    # записане правило читання екрана, яке інакше нема де тримати —
    # «Emitting» без рядка шару це суперечність, а не «друкує». Тести цю
    # умову перевіряють; коли картка SISMA почне показувати стан, брати
    # значення звідси, а не рахувати заново.
