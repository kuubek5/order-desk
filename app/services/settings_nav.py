...
NAV: tuple = (
    ...
    NavGroup(
        ...
        items=(
            ...
            # Заготовки: тека CAM із дисками. Оператор редагує нарівні з
            # адміном — це шлях на його машині й щоденне замовлення
            # комірниці, той самий довід, що для решти обладнання.
            NavItem(
                key="blanks",
                title="Заготовки",
                href="/settings#blanks",
                edit_roles=None,
                keywords=("диски", "blk", "комірник", "склад", "замовлення", "cam-bl"),
            ),
        ),
    ),
    NavGroup(
