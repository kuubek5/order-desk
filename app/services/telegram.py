...
Бот — окремий бот KuubMill; сюди приходить лише його токен (у налаштуваннях,
зашифровано) і chat_id власника. Виходить наверх через
...
# Префікс кожного повідомлення KuubMill. Сповіщення читають і з екрана
# блокування, де назви чату не видно, — мітка каже, звідки вони.
KMILL_PREFIX = "🏭 KMill"
