...
#
# КОРІНЬ, а не повні слова (08.09.26). Список був у знахідному відмінку
# («на швидку», «швидку»), і через це мовчав на кожній третій реальній заявці:
# у базі 35 коментарів зі словом швидк-, і 13 із них — «швидка (робота за
# 14/07)», «швидко плс», «погоджен, швидка», «одна робота 184 [швидко]» —
# не давали ЖОДНОЇ позначки в черзі. 37% справжніх прохань техніка були
# невидимі. Корінь ловить усі 35; на цих даних жодного хибного спрацювання
# не виміряно, бо «швидкість» у коментарях для CAM не пишуть.
RUSH_STEMS = ("швидк", "терміново")

# Зберігаємо старе ім'я: на нього могли посилатись зовні. Це вже не повний
# перелік форм, а те, що корінь і так покриває.
