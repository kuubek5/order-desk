...
має бачити: «Журнал синку» і «Звернення» — адмінські. Показати оператору пункт і
...
COMMANDS: list[dict] = [
    ...
    {"label": "Журнал зв'язку з верстатами", "group": "Історія", "href": "/machines/diag",
     "keywords": "machines diag zvyazok обриви верстати мережа брандмауер агент",
     "admin": True},
    ...
    {"label": "Звернення (зворотний звʼязок)", "group": "Система",
     "href": "/feedback/inbox",
     "keywords": "feedback vkhidni zvernennia звернення скарги баги ідеї", "admin": True},
