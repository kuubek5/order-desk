...
# (та сама логіка, що в черзі, де цирконію смуги на краю рядка немає). СЛМ теж
# без заливки — такої домовленості в таблиці не видно, вигадувати колір за
# лабораторію не можна.
#
# Відтінки — зі стандартної палітри Google Таблиць, тієї самої, з якої взято
# синій рядка (#4A86E8): у лаби вони ставляться тим самим пікером, тож нові
# рядки мусять збігатися з тими, що вписані рукою.
_ORANGE = {"red": 1.0, "green": 0.6, "blue": 0.0}   # #FF9900 — ПММА (і каппа)
_GREEN = {"red": 0.0, "green": 1.0, "blue": 0.0}    # #00FF00 — титан
_CYAN = {"red": 0.0, "green": 1.0, "blue": 1.0}     # #00FFFF — віск (бірюза)
_MATERIAL_FILLS = {
    "ПММА": _ORANGE,
    "Титан": _GREEN,
    "Віск": _CYAN,
