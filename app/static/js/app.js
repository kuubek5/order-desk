...
// Вузьке вікно — рейка згортається сама.
//
// Частина операторів тримає браузер на ПІВЕКРАНА (власник, 15.09.26). На
// моніторі 1920 це вікно 960px, з яких розгорнута рейка забирає 203 — і
// таблиці черги лишається 680 при потрібних ~1100. За краєм опинявся шлях-ID
// і поле Sum3D, тобто обидві дії, заради яких чергу й відкривають.
//
// Збережений вибір оператора НЕ перезаписується: у сховище тут не пишемо
// нічого. Поки вікно вузьке, рейка згорнута; щойно поширшало — повертаємо
