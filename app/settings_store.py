...
PREFERENCE_KEYS = {
    ...
    # Чат логістів (зазвичай група, id з мінусом): щоранку о 08:00 туди йде
    # звіт по пічках, а на запит «/pechi» — час відкриття. Порожньо — вимкнено.
    # telegram_logistics_sent: штамп дня, за який ранковий звіт уже поставлено
    # в чергу (щоб рестарт о 08:05 не слав його вдруге).
    "telegram_logistics_chat_id",
    "telegram_logistics_sent",
