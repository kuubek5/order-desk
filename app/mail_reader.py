...
def _reflect_processed_folder(
    ...
    Лист на другому етапі — теж оброблений: мітка папки міняється на другу, а
    `mailbox_moved_at` стає часом переходу (у кожної папки своя вкладка
    «сьогодні»). Без цього в перший же синк 0.21.1 72
