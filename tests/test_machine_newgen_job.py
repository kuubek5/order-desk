...
SHOP_FRAMES = {
    ...
    # 17.09.26, кадри з самих верстатів (теку `newgen_unread` пише застосунок,
    # коли екран JOBS видно, а назву прочитати не вдалось). Три верстати
    # мовчали тижнями: 250i — цифра №2 хвоста, «0» на відстані 36 від свого
    # еталона й 52 від чужої «3»; 150i — цифра №1, «2» рівно на порозі 28 при
    # потрібному відриві 12. Тобто не хибне читання, а чесна відмова: еталонів
    # для ЦИХ накреслень не було. Лікування — варіанти з цих самих кадрів
    # (`scripts/newgen_glyphs.py learn`), набір виріс із 78 до 122 без втрати
    # жодного старого.
