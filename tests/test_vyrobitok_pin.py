"""ПІН розділу «Виробіток» зберігається хешем, а не відкритим кодом (K.9).

Розділ ховає зарплатні цифри від самих операторів — тобто від людей, які
сидять за цією ж машиною й мають доступ до тієї ж бази, а отже й до ключа
розшифрування налаштувань. Шифрування тут не захищає ні від кого; хеш —
захищає.
"""
