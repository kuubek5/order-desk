...
PALETTE_ONLY = {
    "/account",
    # Пошук має ОДИН вхід — поле з лупою в шапці черги (воно ж відкриває
    # палітру). Окремий пункт у рейці був другим входом у те саме й лише
    # змушував обирати, куди клікнути (07.09.26).
    "/search",
    # Журнал зв'язку з верстатами — розбір після факту, не щоденний екран.
    # Пункт у рейці власник відхилив (10.09.26: «меню і так перенасичене»);
    # вхід — кнопка в шапці «Верстати», посилання з «Що не так» і Ctrl+K.
    "/machines/diag",
}
